            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <h5 class="font-sans text-lg text-gray-800 dark:text-gray-200 leading-tight">
                        {{ __('Identificador: Codigo interno del departamento.
                               Dependencia: Dependencia a la que pertenece.
                    ...
                    <form method="POST" action="{{ route('departments.store') }}">
                        ...
                        <div>
                            <x-input-label for="dependencia" :value="__('Dependencia')" />
                            <select class="peer h-full w-full rounded-[7px] ">
                            @foreach ($dependencies as $dependency)
                            <option value="{{$dependency->}}">One</option>
