                        ...
                        <tbody>
                            @foreach ($researchers as $researcher)
                                <tr>
                                    ...
                                    <td class="text-center">{{ $researcher->rut }}</td>
                                    <td class="text-center">{{ $researcher->nombre }}</td>
                                    <td class="text-center">{{ $researcher->sexo }}</td>
                                    <td class="text-center">{{ $researcher->vigente}}</td>
                                    <td class="text-center">{{ $researcher->dependencia}}</td>
                                    <td class="text-center">{{ $researcher->in_ex}}</td>
                                    <td class="text-center">{{ $researcher->interno_externo}}</td>
                                    <td class="text-center">{{ $researcher->centro}}</td>
