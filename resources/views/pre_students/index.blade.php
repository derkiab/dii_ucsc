            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <x-add-button class="mb-10">
                        {{ __('Añadir Estudiante de Pregrado') }}
                    </x-add-button>

                    <table id="pre_students-table" class="display">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            @foreach ($pre_students as $pre_student)
                                <tr>

                                    <td class="text-center">{{ $pre_student->rut }}</td>
                                    <td class="text-center">{{ $pre_student->nombre }}</td>
                                    <td class="text-center">{{ $pre_student->sexo }}</td>
                                    <td class="text-center">{{ $pre_student->pregrado}}</td>
