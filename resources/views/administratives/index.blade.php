            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <x-add-button class="mb-10">
                        {{ __('Añadir Administrativo') }}
                    </x-add-button>

                    <table id="administratives-table" class="display">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            @foreach ($administratives as $administrative)
                                <tr>
                                    ...
                                    <td class="text-center">{{ $administrative->rut }}</td>
                                    <td class="text-center">{{ $administrative->nombre }}</td>
                                    <td class="text-center">{{ $administrative->sexo }}</td>
                                    <td class="text-center">{{ $administrative->dependencia }}</td>
