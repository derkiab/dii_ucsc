        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <table id="academics-table" class="display">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            @foreach ($academics as $academic)
                                <tr>
                                    ...
                                    <td class="text-center">{{ $academic->sexo }}</td>
                                    <td class="text-center">{{ $academic->vigente }}</td>
                                    <td class="text-center">{{ $academic->centro }}</td>
                                    <td class="text-center">{{ $academic->departamento }}</td>
