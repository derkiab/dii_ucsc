            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <x-add-button class="mb-10">
                        {{ __('Añadir Estudiante de Postgrado') }}
                    </x-add-button>

                    <table id="post_students-table" class="display">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            @foreach ($post_students as $post_student)
                                <tr>

                                    <td class="text-center">{{ $post_student->rut }}</td>
                                    <td class="text-center">{{ $post_student->nombre }}</td>
                                    <td class="text-center">{{ $post_student->sexo }}</td>
                                    <td class="text-center">{{ $post_student->postgrado }}</td>
