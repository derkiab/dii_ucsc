        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <table id="part_times-table" class="display">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            @foreach ($part_times as $part_time)
                                <tr>

                                    <td class="text-center">{{ $part_time->rut }}</td>
                                    <td class="text-center">{{ $part_time->nombre }}</td>
                                    <td class="text-center">{{ $part_time->sexo }}</td>
                                    <td class="text-center">{{ $part_time->dependencia}}</td>
